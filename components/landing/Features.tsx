        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
          {t.items.map((feature, index) => (
            <AnimatedSection
              ...
              delay={index * 100}
            >
              <div className="group relative overflow-hidden rounded-2xl border border-gray-100 bg-white p-8 shadow-sm transition-all duration-300 hover:border-primary/20 hover:shadow-xl hover:-translate-y-1">
